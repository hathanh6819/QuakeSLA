  ...
  return <>
    ...
    <main id="top" className={page === "console" ? "console-page" : undefined}>
      ...
      <section className="metrics-strip">
        ...
        <Metric icon={<FileCheck2 />} label="Policies on-chain" value={count.isLoading ? "Loading" : count.isError ? "Unavailable" : String(count.data ?? 0)} />
